...
<div class="container">
  ...
  <h1 class="text-white text-center" style="text-align: center;">
    <img class="silent-night-logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/silent_night_logo.png" style="max-width: 100%;"/>
    <img class="silent-night-logo-2" src="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/silent_night_logo_2.png" style="max-width: 100%;"/>
  </h1>
  <h2 id="tagline" class="text-white text-center mb-more mt-3" style="font-size: 1rem; margin-right: -17rem;">
...
<div id="silent-night-content" class="container">
  <nav id="silent-night-menu" class="hide-for-test">
    <ul class="d-block d-md-flex justify-content-center m-0 p-0 mb-more text-uppercase">
      ...
      <li class="text-center d-block d-md-inline-block me-0">
        <a class="d-inline-block px-3 py-2 rounded" style="cursor: pointer;" data-toggle="modal" data-target="#cirbolya-modal">A cirbolyafenyő</a>
      </li>
    </ul>
  </nav>

  <div id="bm-featured-carousel" class="mb-more bg-white rounded" style="overflow: hidden;">
    <div class="bm-featured-carousel-item rounded">
      <div class="bm-featured-carousel-item-inner rounded">
        <img data-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/DSC_0124.jpg?20200503">
      </div>
    </div>
    <div class="bm-featured-carousel-item rounded">
      <div class="bm-featured-carousel-item-inner rounded">
        <img data-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/DSC_0277.jpg?20200503">
      </div>
    </div>
    <div class="bm-featured-carousel-item rounded">
      <div class="bm-featured-carousel-item-inner rounded">
        <img data-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/DSC_1174.jpg?20200503">
      </div>
    </div>
    <div class="bm-featured-carousel-item rounded">
      <div class="bm-featured-carousel-item-inner rounded">
        <img data-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/DSC_0308.jpg?20200503">
      </div>
    </div>
    <div class="bm-featured-carousel-item rounded">
      <div class="bm-featured-carousel-item-inner rounded">
        <img data-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/DSC_1132.jpg?20200503">
      </div>
    </div>
    <div class="bm-featured-carousel-item rounded">
      <div class="bm-featured-carousel-item-inner rounded">
        <img data-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/DSC_0011.jpg?20200503">
      </div>
    </div>
  </div>

  <div class="row mb-more">
    <div class="col">
      <div class="card">
  ...
  <div class="row mb-more position-relative">
    <div id="a-teszt" class="position-absolute" style="bottom: 50vh;"></div>
    <div class="col text-center">
      <button class="btn btn-default btn-sn-cta py-4 px-5 font-weight-bold" data-toggle="modal" data-target="#test-modal">
        JÖHET A TESZT!
      </button>
    </div>
  </div>
  ...
  <div class="row mb-more">
    <div class="col-lg-5 mb-3 mb-lg-0">
      <div class="rounded img16-9-m" data-bg-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/DSC_0269.jpg"></div>
    </div>
    <div class="col-lg-7">
      <div class="card">
        <div class="card-body text-justify">
  ...
  <div class="row mb-more">
    <div class="col-lg-5 order-lg-2 mb-3 mb-lg-0">
      <div class="rounded img16-9-m" data-bg-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/DSC_1174.jpg"></div>
    </div>
    <div class="col-lg-7">
      <div class="card">
        <div class="card-body text-justify">
  ...
  <div class="row mb-more">
    <div class="col-lg-4 mb-3 mb-lg-0">
      <div class="rounded img16-9-m" data-bg-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/DSC_1132.jpg"></div>
    </div>
    <div class="col-lg-8">
      <div class="card">
        <div class="card-body text-justify">
          ...
          <div id="silent-night-reviews">
            ...
            <div class="review-item d-flex flex-column">
              <div style="flex: 1 1 auto;">
                ...
                <p class="text-indent-1 font-italic">"Zselykém elég "rossz alvó", van, hogy délután sem tud aludni. A pörgős és fárasztó mindennapok ellenére elég későn alszik el és éjjel is többször ébred. Már az első éjszaka, mikor a <img class="logo-small" src="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/silent_night_logo.png"/> alváskönnyítő Sóhegyecskével aludt, nyugodtan telt, az éjszakát teljesen átaludta! Végre tud nyugodtan pihenni, aminek pozitív hatása a napi ritmusán is megmutatkozik. Sőt! Nem csak ő és mi alszunk jobban, hanem Brumi Úr és Kutyus Pajti is, akiknek Zselyke néha kölcsönadja a Sóhegyecskét, mert szerinte is "Ettől tudsz majd aludni szépen!"."</p>
              </div>
              <p class="mb-0 text-right">
                <i class="fas fa-star"></i>&nbsp;
                <strong>Kántor-Skrapits Eszter</strong>, a 3 éves <strong>Zselyke</strong> és a 6 hónapos <stong>Boti</stong> Anyukája
              </p>
            </div>
  ...
  <div class="card-deck mb-more">
    <div class="card p-3 border-0">
        <div class="card-img-top">
          <div class="img16-9 rounded" data-bg-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/maison.jpg"></div>
        </div>
        <div class="card-body px-0">
          <h5 class="card-title pb-3 border-bottom text-center">
            <a href="http://www.maisonblog.hu/3-dolog-ami-segit-a-gyors-es-kellemes-altatasban" target="_blank">
        ...
        <div class="card-footer px-0 pb-0 bg-transparent">
          <a href="http://www.maisonblog.hu/3-dolog-ami-segit-a-gyors-es-kellemes-altatasban/" class="font-weight-bold">
            Tovább a cikkre&nbsp;
    ...
    <div class="card p-3 border-0">
        <div class="card-img-top">
          <div class="img16-9 rounded" data-bg-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/DSC_0270.jpg"></div>
        </div>
        <div class="card-body px-0">
          <h5 class="card-title pb-3 border-bottom text-center">
            <a href="/2018/09/17/csak-egy-parna-es-mar-alszik-is/" target="_blank">
        ...
        <div class="card-footer px-0 pb-0 bg-transparent">
          <a href="/2018/09/17/csak-egy-parna-es-mar-alszik-is/" class="font-weight-bold">
            Tovább a cikkre&nbsp;
            <i class="fas fa-angle-double-right"></i>
          </a>
        </div>
  ...
  <div class="row">
    <div class="col mb-more text-center">
      <button class="btn btn-default btn-sn-cta py-4 px-4 font-weight-bold" data-toggle="modal" data-target="#test-modal">
...
<div class="container">
  <div id="konnyu-elalvas-teszt" v-cloak v-if="name">
          ...
          <div class="card-body">
            ...
            <label class="answer-label d-block" v-for="(answer, z) in question.answers" :key="z" :class="{'cursor-pointer': !isSubmitted, 'semi-transparent': isSubmitted && question.selected !== answer.v}">
              ...
              <div class="radio-custom position-relative d-inline-block">
                <i class="far fa-star position-absolute click-effect"></i>
                <i class="fas fa-star position-absolute radio-center"></i>
                <i class="far fa-star position-absolute position-absolute"></i>
              </div>
              {{ answer.a }}
            </label>
          </div>
    ...
    <p class="text-white text-right mt-2 mb-more">
      <small>
    ...
    <div class="row mb-more">
      <div class="col text-center">
        <button class="btn btn-default btn-sn-cta py-4 px-5 font-weight-bold" @click="submit" :disabled="!isSubmittable || isSubmitted">
          MUTASD AZ EREDMÉNYT!
        </button>
      </div>
    </div>
    <div class="row mb-more" v-if="isSubmitted">
      <div class="col" id="teszt-eredmeny">
        ...
        <div class="row">
          <div class="col-lg-5 mb-3 mb-lg-0">
            <div class="rounded img1-1-m" data-bg-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/silent_night/DSC_0308.jpg?20210221" style="background-position: center;"></div>
          </div>
          <div class="col-lg-7">
    ...
    <div class="row" v-if="isSubmitted">
      <div class="col text-center mb-more">
        <!-- <a class="btn btn-default btn-sn-cta py-4 px-5 font-weight-bold" :href="result.c > result.l ? links['c'] : links['l']"> -->
        <a class="btn btn-default btn-sn-cta py-4 px-5 font-weight-bold" :href="resultUrl">
...
<div class="container clearfix">
  <div class="card mb-5">
    <div class="card-body">
      <div class="float-rt">
        <div class="rounded p-2 bg-white mb-2 mb-md-0">
          <div class="bg-white mb-3" data-bg-lazy="<?php echo get_template_directory_uri(); ?>/assets/images/mintaoltalom_logo.png" style="padding-top: 30%; background-size: cover; background-position: center;"></div>
        </div>
      </div>
...
<div class="container">
  <div class="row">
    <div class="col-12 col-md-6 mb-5 mb-md-0">
      <div class="fb-page" data-href="https://www.facebook.com/babymountainhimalaya/" data-width="500" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/babymountainhimalaya/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/babymountainhimalaya/">BabyMountain</a></blockquote></div>
    </div>
...
<div id="test-modal" class="modal fade" tabindex="-1" role="dialog" <?php echo $is_xmas ? 'data-backdrop="static" data-show="true"' : ''; ?>>
    ...
    <div id="test-modal-content" class="modal-content">
      <form @submit.prevent="submit">
        ...
        <div class="modal-footer border-top-0 pt-0">
          <button type="submit" :disabled="!nickname" class="btn btn-secondary" style="background-color: #0f0f26 !important; border-color: #0f0f26 !important;">Tovább a teszthez</button>
        </div>
      </form>
    </div>
  </div>
...
<script>
  function Star () {
    ...
    document
      .querySelector('#bm-content-wrapper')
      .appendChild(el);
  }
  ...
  window.addEventListener('load', function () {
    var konnyuElalvasTeszt = new Vue({
      ...
      data: {
        ...
        xmasVariants: {
          c: 'Citromverb%C3%A9na%20-cirbolyafeny%C5%91-%20krist%C3%A1lys%C3%B3',
          l: 'Levendula-cirbolyafeny%C5%91-%20krist%C3%A1lys%C3%B3'
        }
      },
      computed: {
    ...
    $('#test-modal').on('shown.bs.modal', function () {
      $('#test-modal input').trigger('focus');
    });
  });
</script>
...
<style>
  ...
  body {
    ...
    background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/silent_night_stars.png'), url('<?php echo get_template_directory_uri(); ?>/assets/images/silent_night_overlay_bg.svg') !important;
  }
  html {
  ...
  #main-footer {
    z-index: -1;
    background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/silent_night_2020.png') !important;
  ...
  #silent-night-reviews .slick-track {
    display: flex;

  }
  #silent-night-reviews .review-item {
    height: auto;
  }
  #silent-night-reviews .slick-next {
    right: -50px !important;
  }
  #silent-night-reviews .slick-prev {
    left: -50px !important;
  }
  [v-cloak] {
    display: none;
  ...
  .bm-featured-carousel-item-inner {
    padding-top: 60%;
  }
  [data-bg-lazy] {
    height: 100%;
  ...
  #bm-featured-carousel .slick-arrow:before {
    /* color: rgb(224, 185, 124) !important; */
    color: rgb(185, 209, 193) !important;
    text-shadow: 0 0 10px black;
    font-size: 20px;
  }
  #bm-featured-carousel .slick-arrow:after {
    content: none !important;
  }
  #bm-featured-carousel .slick-prev {
    left: 1rem !important;
  }
  #bm-featured-carousel .slick-next {
