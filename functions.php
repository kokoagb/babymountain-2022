 ...
 */
function bm_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'bm' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'bm' ),
...
add_action( 'widgets_init', 'bm_widgets_init' );
